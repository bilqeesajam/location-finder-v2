      ...
      <Card className="p-4 bg-white shadow-sm">
        <div className="flex flex-col lg:flex-row gap-4">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="relative">
              <select
                className="appearance-none bg-white border border-gray-300 rounded-lg px-4 py-2 pr-8 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-gray-700"
                value={filterAction}
                onChange={(e) => {
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              ...
              className="h-8 w-8 p-0 border-gray-300 text-gray-700 hover:bg-gray-50 disabled:opacity-50"
            >
