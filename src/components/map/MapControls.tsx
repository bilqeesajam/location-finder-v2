...
import { Search as SearchIcon, SlidersHorizontal, Utensils, Hospital, Camera, Train, Landmark, ShoppingCart, ChevronRight, School } from "lucide-react";
        ...
        <>
            ...
            <div className="absolute top-4 right-12 z-20 pointer-events-auto">
                <div className="h-12 w-12 rounded-full overflow-hidden shadow-lg cursor-pointer">
                    <img src="https://preview.redd.it/i-basically-made-this-to-use-as-my-profile-pic-v0-07abexsid6oc1.png?auto=webp&s=ddd1dfd7202724fac2060cc43fb223618c3b6f65" alt="User Profile" className="h-full w-full object-cover" />
                </div>
            </div>

            <div className={cn("absolute top-4 left-1/2 -translate-x-1/2 z-20 pointer-events-auto flex flex-col items-center gap-4", className)}>
                <div className="flex items-center gap-3">
                    ...
                    <Popover>
                        <PopoverTrigger asChild>
                            <Button
                                className="h-11 w-11 rounded-[19px] bg-[#009E61] text-white shadow-lg hover:bg-[#00B36D]"
                            >
                ...
                <div className="flex items-center gap-1.5 w-[550px]">
                    <div ref={scrollRef} className="flex items-center gap-1.5 overflow-x-hidden no-scrollbar scroll-smooth flex-1">
                        {categories.map((cat) => (
                            <button
                                key={cat.key}
                                ...
                                className={cn(
                                    ...
                                    selectedServices.includes(cat.key) && "border-[#009E61] bg-[#009E61]/20"
                                )}
                            >
                    ...
                    <button onClick={scrollNext} className="flex items-center justify-center h-8 w-8 rounded-full bg-[#0F2A2E]/90 border border-white/10 shrink-0 hover:bg-[#009E61] transition-colors">
