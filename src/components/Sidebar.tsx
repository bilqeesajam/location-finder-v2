        ...
        <>
            ...
            <aside
                className={cn(
                    ...
                    isOpen ? 'translate-x-0 opacity-100 scale-100' : 'translate-x-full opacity-0 scale-[0.98] md:translate-x-0 md:opacity-100 md:scale-100'
                )}
                style={{
                    background: BG,
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                    ...
                    {selected && (
                        ...
                        >
                            <div className="flex items-start gap-3">
                                <div className="mt-1 h-2.5 w-2.5 rounded-full" style={{ background: ACCENT }} />
                                <div className="min-w-0">
                                    ...
                                    {(selected as any)?.type && (
                                        <p className="text-sm text-white/70 truncate">{(selected as any).type}</p>
                                    )}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            ...
                            <p className="text-2xl font-bold text-white">{approvedLocations.length}</p>
                        </div>
                    ...
                    {user && (
                        <div className="space-y-2">
                            <Button
                                ...
                                style={{
                                    background: isAddingLocation ? ACCENT : 'rgba(255,255,255,0.04)',
                                    borderColor: isAddingLocation ? `${ACCENT}55` : 'rgba(255,255,255,0.08)',
                                    color: 'white'
                                }}
                            >
                            ...
                            <Button
                                ...
                                className={cn('w-full justify-start gap-3 border')}
                                style={{
                                    background: isSharing ? `${ACCENT}` : 'rgba(255,255,255,0.04)',
                                    borderColor: isSharing ? `${ACCENT}55` : 'rgba(255,255,255,0.08)',
                                    color: 'white'
                                }}
                            >
                    ...
                    <div className="space-y-1">
                        ...
                        {user && userLocations.length > 0 && (
                            <div className="pt-2">
                                <p className="text-xs text-white/60 px-1 mb-2">Your Locations</p>
                                    ...
                                    {userLocations.slice(0, 5).map((loc) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                style={{
                                                    border: isSelected ? `1px solid ${ACCENT}55` : '1px solid transparent'
                                                }}
                                            >
                                                <div
                                                    className="w-2 h-2 rounded-full"
                                                    style={{ background: isSelected ? ACCENT : 'rgba(255,255,255,0.35)' }}
                                                />
                                                <span className="text-sm truncate flex-1 text-white">{loc.name}</span>
                                                <span
                                                    className="text-xs px-2 py-0.5 rounded-full capitalize"
                                                    style={{
                                                        background: 'rgba(255,255,255,0.06)',
                                                        color: loc.status === 'approved' ? ACCENT : 'rgba(255,255,255,0.7)',
